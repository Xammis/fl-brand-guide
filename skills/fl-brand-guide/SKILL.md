...
The reference contains the current typography, color, logo, navigation, link, button, spacing, surface, punctuation, nesting, responsive, and report-generation rules. Treat every rule in that reference as mandatory unless the user explicitly requests an exception.
